...
# -- Project information -----------------------------------------------------
project = 'CULVERT Web-Application'
copyright = '2025, USDA-FS & US-DOT'
author = 'Sourav Mukherjee, ORISE USDA-FS Research Fellow'
release = '1.0.0'
...
html_theme_options = {
    'repository_url': 'https://github.com/SouravDSGit/CULVERT-Manual',
